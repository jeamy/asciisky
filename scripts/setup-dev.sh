...
echo "   - precompute_worker (Task Processor)"
echo "   - asteroid-worker-1, asteroid-worker-2 (Compute)"
echo "   - comet-worker-1, comet-worker-2 (Compute)"
echo ""
echo "📝 Useful commands:"
echo "   docker compose logs -f web                    # Web logs"
echo "   docker compose logs -f precompute_coordinator # Precompute coordinator"
echo "   docker compose logs -f precompute_worker      # Precompute worker"
echo "   docker compose logs -f asteroid-worker-1      # Asteroid worker"
